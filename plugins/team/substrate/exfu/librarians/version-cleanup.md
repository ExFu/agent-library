...
2. List the version directories that actually exist under `exfu/` -- timestamp-named (e.g. `20260724-1831`) and legacy `v0.x`-named (e.g. `v0.3`) alike -- and read `exfu/latest.txt` if present.
